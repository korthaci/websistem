...
if (isset($_GET['ui'])) {
	...
	$case = [
		...
		'modulduzenle' =>		['php' => 'modulduzenle',		'yetki' => [2,3],		'_class' => ' g_98__ margin_a'],
		'modulsablonlar' =>		['php' => 'modulsablonlar',		'yetki' => [2,3],		'_class' => ' g_98__ margin_a'],
		...
		'ai_static_site_generator' =>	['php' => 'ai_static_site_generator',	'yetki' => [2],		'_class' => 'uis-container uis-mt-4'],
