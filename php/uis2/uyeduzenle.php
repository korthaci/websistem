...
if (n0_($u_no__)) {
	...
	try {
		...
		if ($sb_) {
			echo 
			$sb_->no.' | <a href="ui/uyeler">·Liste·</a> | 
				...
				<div class="uis-container">
					<div class="uis-row">
						<div class="uis-col uis-col-md-8">
							...
							<div class="uis-mb-3">
								<label class="uis-label">'.yc("Telefon").'</label>
						...
						<div class="uis-col uis-col-md-4 uis-text-end">
							...
							<div data-placeholder="'.yc("Şifre").'">
								<input name="_sifre" class="g_1__ i2 uis-input dbldisabled" type="password" value="" readonly placeholder="'.yc("Şifre").'" />
							</div>
							<input class="uis-input g_60_ i2 dbtext dbldisabled" type="text" value="'.$sb_->yetki_no.'"   placeholder="'.yc("Yetki").'" readonly  data-nta="'.sifrele($sb_->no.',,uyeler,,yetki_no').'"/>
							<input class="uis-input g_60_ i2 dbtext dbldisabled" type="text" value="'.$sb_->aktivasyon.'" placeholder="'.yc("Aktivasyon").'" readonly  data-nta="'.sifrele($sb_->no.',,uyeler,,aktivasyon').'" /><br/>' .
